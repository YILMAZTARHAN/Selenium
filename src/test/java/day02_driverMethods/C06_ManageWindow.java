...
public class C06_ManageWindow {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Maximize durumunda positon: "+driver.manage().window().getPosition());
        ...
        System.out.println("Fullscreen durumunda positon: "+driver.manage().window().getPosition());
